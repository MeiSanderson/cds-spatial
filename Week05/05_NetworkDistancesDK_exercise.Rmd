...
my_token <- _find online and insert again_ ## IF sharing; like on GitHub -> DO THE BELOW (save and loaded as .txt file in _gitignore_), so that the token is shared with others
